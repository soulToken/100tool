...
Page({
  ...
  onLoad: function(option) {
    ...
    this.setData({
      ...
      headUrl:clicicInfo.headUrl,
      region:[clicicInfo.provice,clicicInfo.city,clicicInfo.area],
      clinicIntroduce: clicicInfo.clinicIntroduce,
      address:clicicInfo.address
    })
    this.getEnvironment()
  },
  onShow() {
